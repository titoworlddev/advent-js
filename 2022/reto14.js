function getOptimalPath(path) {
  ...
  return rev.slice(1).reduce((total, curr) => {
    total = curr.map((num, i) => Math.min(total[i], total[i + 1]) + num);
    return total;
  }, rev[0])[0];
}

// getOptimalPath([[3, 2, 3]]); // 2
// 0 -> 2
...
//   [2, 4, 6]
// ]
// Del que esta en su misma posicion y una mas, el mas pequeno
// [
//      [1],
//     [1, 5],
//    [7, 5, 8],
